// WAP Program to find the largest and smallest word in a string

public class Str13FindLSVal    
  {
  public static void main(String[] args){     
      String string = "Hi my name is Pavan I am taking training in bitlabs";    
